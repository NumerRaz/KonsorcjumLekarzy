...
-- --------------------------------------------------
-- Date Created: 04/23/2017 18:58:08
-- Generated from EDMX file: C:\Users\michal\Documents\Projects\Konsorcjum\KonsorcjumLekarzy\Model\KonsorcjumDB.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_DoctorSpecialization]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Specializations] DROP CONSTRAINT [FK_DoctorSpecialization];
GO
...
-- Creating foreign key on [Doctor_DoctorId] in table 'Specializations'
ALTER TABLE [dbo].[Specializations]
ADD CONSTRAINT [FK_DoctorSpecialization]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_DoctorSpecialization'
CREATE INDEX [IX_FK_DoctorSpecialization]
